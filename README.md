# Youssef Mohamed El-Qadi

## Pipeline Technical Director & Computer Graphics TD

Results-driven Pipeline Technical Director and Computer Graphics TD with over four years of programming experience, specializing in 3D asset creation, environment design, and full-stack application development. Expert in C++, Python, and graphics APIs like Vulkan, with extensive experience developing production-grade 3D applications using Qt frameworks. Highly proficient in Maya and Houdini, specializing in advanced rigging, animation, and procedural tool development to streamline production pipelines.
...
- **Languages:** Python, C++, TypeScript, JavaScript, Dart, Java, HTML, CSS, MEL
- **Frameworks & UI:** PyQt6, PySide6, Qt (C++), React, Vite, Tailwind CSS, Flutter
- **Graphics & Engines:** Vulkan, Real-time Rendering, PBR, Animation Systems, Qt-based Editors

### Pipeline & Production Tools
- **DCCs:** Maya, Houdini, Nuke, Unreal Engine, Blender, Substance, Nuke Studio
- **Pipeline Systems:** Prism-style pipelines, Kitsu integration, render farm management (Deadline)
- **Workflows:** Asset/shot/version management, publishing workflows, production tracking

### Specializations
- Studio pipeline architecture and design
- Production tool development for Maya and Houdini
- DCC integration with render farms and production trackers
- Full-stack 3D application development
...
- **LinkedIn:** [linkedin.com/in/youssef-mohamed-6a78a4247](https://linkedin.com/in/youssef-mohamed-6a78a4247)
- **Portfolio:** [portofolio-rouge-five.vercel.app](https://portofolio-rouge-five.vercel.app)
...
- **9-Month Professional Diploma, CG Technical Director** – Information Technology Institute (ITI)  
